...
public class TetrisPiece
{
	...
	{
		return PIECES.get(MCACore.RAND.nextInt(PIECES.size())).clone();
	}
	...
	{
		Location loc = new Location(MCACore.gameWorld, gameLocScaled.getX() + gameLoc.getX(), gameLocScaled.getY() + gameLoc.getY(), gameLocScaled.getZ() + TetrisGame.DIST_FROM_PLAYER);
